 ...
 *
 * @component
 * @param {SvgProps} props - The properties for the SVG component, including color and other attributes.
...
export const ArrowDownIcon: FC<SvgProps> = (props: SvgProps): JSX.Element => (
  <Svg viewBox="0 0 48 48" {...props}>
    ...
    <Path
      d="M24 29.171L9.414 14.585 6.586 17.413 24 34.827 41.414 17.413 38.586 14.585z"
      fill={props.color}
    />
  </Svg>
);
